...
# However, the program could have a python list instead of the tuple.
...
answers_8_ball = ( "As I see it, yes",  "Ask again later",
    ...
    "My soruces say no", "Outlook good",
    "Outlook not so good", "Reply hazy try again",
    "Signs point to yes", "Very doubtful",
    "Without a doubt", "Yes",
    "Yes definitly", "You may rely on it")
...
def main():
    ...
    while another_question:
        ...
        askAgain = input("\nWould you like to ask me another quesstion (Y or N)?: " )
